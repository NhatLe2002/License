                                                ...
                                                <div class="card-body">
                                                    <div class="card-title d-flex align-items-start justify-content-between">
                                                        <div class="avatar flex-shrink-0">
                                                            <img src="./assets/img/icons/unicons/member.png" alt="chart success" class="rounded">
                                                        </div>
                                                        <div class="dropdown">
                                                    ...
                                                    <span class="fw-medium d-block mb-1">Số nhân viên</span>
                                                    <h3 class="card-title mb-2">${listStaff.size()}</h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-6 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="card-title d-flex align-items-start justify-content-between">
                                                        <div class="avatar flex-shrink-0">
                                                            <img src="./assets/img/icons/unicons/customer.png" alt="Credit Card" class="rounded">
                                                        </div>
                                                        <div class="dropdown">
                                                    ...
                                                    <h3 class="card-title text-nowrap mb-1">${listMember.size()}</h3>
                                        ...
                                        <div class="col-6 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="card-title d-flex align-items-start justify-content-between">
                                                        <div class="avatar flex-shrink-0">
                                                            <img src="./assets/img/icons/unicons/contract.png" alt="Credit Card" class="rounded">
                                                        </div>
                                                        <div class="dropdown">
                                                    ...
                                                    <span class="d-block mb-1">Số hồ sơ</span>
                                        ...
                                        <div class="col-6 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <span class="fw-medium d-block mb-1">Số câu hỏi</span>
                                        ...
                                        <div class="col-12 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <span class="fw-medium d-block mb-1">Tổng số doanh thu</span>
                                                    <h3 class="card-title mb-2">400,000,000 VNĐ</h3>
                                ...
                                <div class="col-md-6 col-lg-4 order-2 mb-4">
                                    <div class="card h-100">
                                        <div class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="card-title m-0 me-2">Đã thanh toán</h5>
                                            <div class="dropdown">
                                        ...
                                        <div class="card-body">
                                            <ul class="p-0 m-0">
                                                <li class="d-flex mb-4 pb-1">
                                                    <div class="avatar flex-shrink-0 me-3">
                                                        <img src="./assets/img/icons/unicons/VNPay.png" alt="User" class="rounded">
                                                    </div>
                                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                        <div class="me-2">
                                                            <small class="text-muted d-block mb-1">VNPay</small>
                                                            <h6 class="mb-0">Nhận</h6>
                                                        </div>
                                                ...
                                                <li class="d-flex mb-4 pb-1">
                                                    <div class="avatar flex-shrink-0 me-3">
                                                        <img src="./assets/img/icons/unicons/cash.png" alt="User" class="rounded">
                                                    </div>
                                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                        <div class="me-2">
