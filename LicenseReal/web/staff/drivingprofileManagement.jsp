                                            ...
                                            <c:forEach var="list" items="${list_driving}" varStatus="counter">
                                                    ...
                                                    <td>
                                                        ...
                                                        <c:if test="${list.flag eq 'false'}">
                                                            <span class="fw-medium">Chưa thanh toán</span>
                                                        </c:if>
                                                    </td>
                                                    <td>
                                                        <c:if test="${list.status eq 'true'}">
                                                            <span class="fw-medium" style="color:#fba265">Đã hoàn tất</span>
                                                        </c:if>
                                                        <c:if test="${list.flag eq 'false'}">
                                                            <span class="fw-medium">Chưa được duyệt</span>
                                                        </c:if>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a
                                                                    class="dropdown-item"
                                                                    href="viewdriving?id=${sessionScope.load_profile.getId()}"
