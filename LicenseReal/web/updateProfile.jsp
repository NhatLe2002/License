                                    ...
                                    <form action="updateProfile" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="basic-info">
                                            ...
                                            <div class="content d-flex">
                                                ...
                                                <div class="input-info">
                                                    <input type="text" id="cccd" name="cccd" value="${load_profile.cccd}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="content d-flex">
                                                ...
                                                <div class="input-info" style="margin-top: 20px;">
                                                    <div
                                                        class="radio-buttons d-flex gap-3 justify-content-center align-items-center">
                                                        <input class="health-certificate" type="radio"
                                                               id="health-certificate-yes" name="health"
                                                               value="${load_profile.health}">
                                                        <label for="health-certificate-yes">Đã có</label>
                                                        <input class="health-certificate" type="radio"
                                                               id="health-certificate-no" name="health" value="${load_profile.health}">
