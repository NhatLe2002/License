...
public class UpdateQuestionController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Question list = dao.getQuestionByID(id);
            request.setAttribute("question", list);

            ArrayList<Answer> answers = list.getAnswer();
            ...
            if (checkDuplicate) {
                ...
                if (checkDuplicate) {
                    ...
                    for (Part filePart : fileParts) {
                        ...
                        if (data.isEmpty()) {
                            Question question1 = dao.getQuestionByID(Integer.toString(questionID));
                        ...
                        if (fileName.endsWith(".png") || fileName.endsWith(".PNG") || fileName.isEmpty()) {
                            ...
                            if (answer_text.isEmpty()) {
                                ...
                                if (!data.isEmpty()) {
                                    //Goi den ham them cau hoi va kiem tra xem da cap nhat du lieu vao bang Question va Answer trong DB thanh cong hay chua
