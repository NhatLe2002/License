...
public class ViewDrivingProfileController extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            session.setAttribute("load_profile", driving);
            
            // Chuyển hướng đến trang updateprofile.jsp
            response.sendRedirect("staff/drivingprofile.jsp");
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ViewDrivingProfileController.class.getName()).log(Level.SEVERE, null, ex);
