...
//        String orderType = request.getParameter("ordertype");
        ...
        vnp_Params.put("vnp_Bill_Address", "");
        vnp_Params.put("vnp_Bill_City", "");
        vnp_Params.put("vnp_Bill_Country", "");

        vnp_Params.put("vnp_Bill_State", "");

        // Invoice
        vnp_Params.put("vnp_Inv_Phone", "");
        vnp_Params.put("vnp_Inv_Email", "");
        vnp_Params.put("vnp_Inv_Customer", "");
