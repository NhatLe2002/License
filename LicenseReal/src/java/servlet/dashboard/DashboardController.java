...
public class DashboardController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<UserDTO> listMember = new ArrayList<>();
        List<UserDTO> listMentor = new ArrayList<>();
        List<UserDTO> listStaff = new ArrayList<>();
        ArrayList<QuestionDTO> listQuestion = new ArrayList<>();
        try {
            listMember = UserDAO.getListByRole(1);
            listMentor = UserDAO.getListByRole(2);
            listStaff = UserDAO.getListByRole(3);
